...
mcp = FastMCP(
    name="web_search", 
    version="1.0.0",
    description="Web search tool for retrieving the latest financial news from CNBC about specific stocks, market trends, and economic events to provide context for investment decisions"
)

...
mcp = FastMCP(
    name="stock_data", 
    version="1.0.0",
    description="Stock data tools for retrieving real-time price information and calculating technical indicators like RSI, MACD, Bollinger Bands, and moving averages to support investment analysis"
